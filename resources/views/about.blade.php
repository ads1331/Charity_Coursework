@include('layouts.header')
    ...
    <div class="owl-carousel-wrapper">
      ...
      <div class="box-92819">
        <h1 class="text-white mb-3">О нас</h1>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-5 ml-auto">
            <h3 class="text-cursive mb-4">Наша миссия</h3>
            ...
            <p><a href="{{ route('contact') }}" class="btn btn-primary rounded-0 px-4">Свзяться с нами</a></p>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-6 text-center mb-5">
            <h2 class="text-cursive">Наша команда </h2>
          </div>
        </div>
